        ...
        <div class="container">
                <div class="box">
                        ...
                        <table class="table table-striped">
                                ...
                                $sql = "SELECT * FROM univarsity WHERE yname LIKE '%".$search."%'";
                                ...
                                ?>
                                        <tbody>
                                                <tr>
                                                        ...
                                                        <td><?php  echo$rows['yname'] ?></td>
                                                        <td><?php echo $rows['yfaculty']; ?></td>
                                                        <td><?php echo $rows['ycourse']; ?></td>
